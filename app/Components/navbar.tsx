    ...
    return (
        <nav className="grid grid-cols-12 border-x-2 border-black 2xl:max-w-[1280px] mx-auto">
            <div className="p-2 border-solid border-y-2 bg-white border-r-2 border-black col-span-3 lg:col-span-1 flex justify-center">
                <NavLink
                    to="/"
                    onClick={(e) => navAnimChanger(e, PAGE_GREETINGS.INDEX)}
                    style={
                        ({ isActive }) =>
                        isActive ? sectionChanger(PAGE_GREETINGS.INDEX) : undefined
                    }
                >
                    ekkymulia
                </NavLink>
                ...
                <ul className={`grid grid-cols-12 transition duration-1000 delay-150 ease-in-out overflow-hidden ${ transition.state == 'idle' ? navAnim.after : navAnim.before}`}>
                        ...
                        <ul className="flex justify-start">
                            ...
                            <li className="ml-4">
                                <NavLink
                                    ...
                                    onClick={(e) => navAnimChanger(e, PAGE_GREETINGS.JOURNAL)}
                                    style={({ isActive }) =>
                    ...
                    <li className="hidden lg:block ml-4 col-span-2">
                        <NavLink
                            ...
                            style={
                            ({ isActive }) =>
                            isActive ? sectionChanger(PAGE_GREETINGS.JOURNAL) : undefined
                            }
                        >
                            Journal (Blog)
                        </NavLink>
                    ...
                    <li className="hidden lg:block ml-4 col-span-2">
                        <NavLink
                            to="/contact"
                            onClick={(e) => navAnimChanger(e, PAGE_GREETINGS.CONTACT)}
                            style={({ isActive }) =>
                            isActive ? sectionChanger(PAGE_GREETINGS.CONTACT) : undefined
                            }
                        >
                            Contact Page
                        </NavLink>
